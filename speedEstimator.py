...
class SpeedEsimator: 
    ...
    def __init__(self, er, el, R, L):
        '''
            el - left wheel encoder
            er - right wheel encoder
            R - wheel's raduis in meters
        ...
        # I don't actually know why we are using this thing over here 

        # converting speed to rpm 
        # self.wl_speed_rpm = (60/self.el.ticks_per_rev) * 10 **9
        # self.wr_speed_rpm = (60/self.er.ticks_per_rev) * 10 **9
